            ...
            Geom,
            {
                ...
                if  (   is.null(params$binaxis) ||
                    ...
                    } else if (params$binaxis == "y")
                    {
                        ...
                        # xmin and xmax aren't really the x bounds, because of the odd way grob
                        # works. They're just set to the standard x +- width/2 so that clusters
                        # can be dodged like other geoms.
                        # After position code is rewritten, each dot should have its own box.
                        df <- ddply(df,
                                    .(group),
                                    transform,
